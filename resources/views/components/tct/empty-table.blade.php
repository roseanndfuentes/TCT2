@props(['colspan' => '1'])
<td colspan="{{ $colspan }}" class="group py-7">
    <div class="flex justify-center px-3 items-center">
        <div class="space-y-2 grid items-center justify-center">
            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" class="h-40 group-hover:rotate-12 duration-150"
